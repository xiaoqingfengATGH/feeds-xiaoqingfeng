...
return view.extend({
	render: function () {
		...
		var content = E('div', {}, [
			...
			h(_('How to use')),
			E('ol', { 'style': 'padding-left:20px;margin:0 0 12px 0' }, [
				li([_('Open the'), ' ', E('a', { 'href': L.url('admin', 'services', 'hometunnel', 'wizard') }, _('Access')), ' ', _('page and follow the wizard: authorize with OAuth in the Cloudflare web page (creates subdomains, deploys the switch service [Worker] and configures its routes), pick your domain, and deploy the switch service.')]),
