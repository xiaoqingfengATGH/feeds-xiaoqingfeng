...
return view.extend({
	render: function () {
		...
		var content = E('div', {}, [
			...
			h(_('How to use')),
			E('ol', { 'style': 'padding-left:20px;margin:0 0 12px 0' }, [
				li([_('Open the'), ' ', E('a', { 'href': L.url('admin', 'services', 'hometunnel', 'wizard') }, _('Access')), ' ', _('page and follow the wizard: authorize with OAuth in the Cloudflare web page, pick your domain, and deploy the switch service. Only the necessary permissions are requested — mainly: reading your account and domain list, deploying the switch service (a Worker) with its route, and managing DNS records for the chosen domain. The app never gets full control of your account.')]),
